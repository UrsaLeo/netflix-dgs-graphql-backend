package com.iamdinuth.commonmicroservice.exception;
 ...
 */
public class AccessDeniedError extends Throwable implements GraphQLError {

    private static final String ERROR = "PERMISSION_DENIED";
